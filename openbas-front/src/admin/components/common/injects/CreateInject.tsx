...
import { type CSSProperties, type FunctionComponent, useEffect, useMemo, useRef, useState } from 'react';
...
import { type AttackPattern, type FilterGroup, type Inject, type InjectorContractOutput, type KillChainPhase } from '../../../../utils/api-types';
