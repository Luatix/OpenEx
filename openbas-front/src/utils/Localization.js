...
const i18n = {
  messages: {
    fr: {
      ...
      'Status': 'Statut',
      'Execution status': 'Execution statut',
      ...
      'Update simulation': 'Modifier la simulation',
      ...
      'START': 'Commencement',
      'PREREQUISITE_CHECK': 'Commande de vérification des prérequis',
      'PREREQUISITE_EXECUTION': 'Commande d\'obtention des prérequis',
      'EXECUTION': 'Commande d\'attaque',
      'CLEANUP_EXECUTION': 'Commande de nettoyage',
      'COMPLETE': 'Dernière trace',
      ...
      'Do you want to launch this atomic testing: {title}?': 'Souhaitez-vous lancer ce test atomique: {title} ?',
      'Do you want to relaunch this atomic testing: {title}?': 'Souhaitez-vous relancer ce test atomique: {title} ?',
      ...
      'Score must be greater than 0': 'Le score doit être supérieur à 0',
      'Score must be less than or equal to 100': 'Le score doit être inférieur ou égal à 100',
      'Message': 'Message',
      'New control': 'Nouveau contrôle',
      'Percent of reached score': 'Pourcentage du score atteint',
      'Pause': 'Pause',
      'Resume': 'Reprendre',
      'Emails and SMS': 'Emails et SMS',
      'injects': 'injects',
      'Paused': 'En pause',
      'Canceled': 'Annulé',
      'Partial': 'Partiel',
      ...
      'This report is not available': 'Ce rapport n\'est pas disponible',
      ...
      'Do you want to delete this agent:': 'Souhaitez-vous supprimer cet agent:',
      'Hostname': 'Nom d\'hôte',
      ...
      'Modify asset groups in this inject': 'Modifier des groupes d\'assets dans ce stimuli',
      ...
      'Parent scenario': 'Scénario parent',
      // Exercise
      ...
      'Target': 'Cible',
      'This atomic testing and its previous results will be deleted': 'Ce test atomique et ses résultats précédants seront supprimés',
      'Traces': 'Traces',
      'Time': 'Temps',
      ...
      'documentation icon': 'icône de documentation',
      ...
      'Latest 10 Finished Simulations': '10 dernières simulations terminées',
      ...
      'Detected': 'Détectés',
      'Successful': 'Réussies',
      'Simulation end date': 'Date de fin de la simulation',
      'Asset rule': 'Règle d\'actifs',
      'Customization': 'Customisation',
      'Default asset rules': 'Règles d\'actifs par défaut',
      'ASSET RULE DETECTED': 'RÈGLE D\'ACTIF DÉTECTÉ',
      'We detected that your change will trigger an {assetrule}. Would you like to apply the defined asset groups on your current existing injects ?': 'Nous avons detecté que votre modification va déclencher une {assetrule}. Voudriez-vous appliquer les groupes d\'actifs définis sur les injects existants ?',
    ...
    zh: {
      ...
      'Do you want to launch this atomic testing: {title}?': '你想启动这个原子测试吗: {truc}?',
      'Do you want to relaunch this atomic testing: {title}?': '您想重新启动此原子测试吗: {title}?',
      'The inject will only be sent to you.':
        '注入只会发送给你.',
      'Try': '尝试',
      'Disable': '禁用',
      ...
      'Success score': '成功分数',
      'Scores': '分数',
      'Score must be greater than 0': '分数必须大于0',
      'Score must be less than or equal to 100': '分数必须小于或等于100',
      'Message': '消息',
      'New control': '新控制',
      ...
      'Do you want to delete this agent:': '您是否要删除这个代理:',
      'Hostname': '主机名',
      'Ip Addresses': 'IP地址组',
      'Ip Address': 'IP地址',
      ...
      'Modify target asset groups': '修改目标资产组',
      'Modify asset groups in this inject': '在此注入中修改资产组',
      'Media pressure': '媒体',
      'Home': '主页',
      ...
      'injector_contract_labels': '标签',
      'injector_contract_platforms': '平台',
      // Scenario
      'scenario_category': '类别',
      'scenario_kill_chain_phases': '杀伤链阶段',
      'scenario_name': '名称',
      'scenario_platforms': '平台',
      'scenario_recurrence': '重复性',
      'scenario_severity': '严重性',
      'scenario_tags': '标签',
      'scenario_updated_at': '更新于',
      'Parent scenario': '母体情景',
      // Exercise
      'exercise_kill_chain_phases': '杀伤链阶段',
      'exercise_name': '名称',
      'exercise_scenario': '场景',
      'exercise_status': '状态',
      'exercise_start_date': '开始日期',
      'exercise_tags': '标签',
      'exercise_updated_at': '更新于',
      // Payload
      'payload_attack_patterns': '攻击模式',
      'payload_name': '名称',
      'payload_description': '描述',
      'payload_platforms': '平台',
      'payload_source': '来源',
      'payload_status': '状态',
      'payload_tags': '标签',
      ...
      'Execution logs': '目标日志',
      'Target': '目标',
      'This atomic testing and its previous results will be deleted': '此原子测试及其之前的结果将被删除',
      'Traces': '跟踪',
      'Time': '时间',
      'global-crisis': '全局危机',
      ...
      'Latest 10 Finished Simulations': '最近 10 个已完成的模拟',
      'Simulate Now': '现在模拟',
      'Human Response': '人工响应',
      'Not planned': '未计划',
      'Endpoint Protection': '终端防护',
      ...
      'Document': '文档',
      'START': '开始',
      'PREREQUISITE_CHECK': '检查先决条件命令',
      'PREREQUISITE_EXECUTION': '获取先决条件命令',
      'EXECUTION': '攻击命令',
      'CLEANUP_EXECUTION': '清理命令',
      'COMPLETE': '完全的',
      // Policies
      ...
      'Detected': '检测到',
      'Successful': '成功的',
      'Simulation end date': '模拟结束日期',
      'Asset rule': '资产规则',
      'Customization': '自定义',
      'Default asset rules': '默认资产规则',
      'ASSET RULE DETECTED': '检测到资产规则',
      'We detected that your change will trigger an {assetrule}. Would you like to apply the defined asset groups on your current existing injects ?': '我们检测到您的更改将触发一个{assetrule}。您是否要在当前已有的注入中应用定义的资产组？',
      'Do you want to delete this asset rule ?': '您要删除此资产规则吗？',
    ...
    en: {
      ...
      'START': 'Start',
      'PREREQUISITE_CHECK': 'Check prerequisites command',
      'PREREQUISITE_EXECUTION': 'Get prerequisites command',
